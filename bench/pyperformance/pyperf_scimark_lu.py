"""scimark LU factorization (dense, partial pivoting), N=100 — port of pyperformance bm_scimark LU.
Classes and LU_factor are verbatim from pyperformance; cycles come from argv (default 200)."""
...
if __name__ == "__main__":
    ...
    s = sum(sum(row) for row in lu.data)
