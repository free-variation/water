...
const HelpEntry help_entries[] = {
	...
	{ "rows>dataset", "( rows header? -- dataset )", "datasets.h2o: column-oriented frame from rows; keys come from row 0 when header? is true, else :col1… are synthesized", "r·c", "k×1a(r) + 1fr", "O(r·c)", 22 },
...
const int help_entry_count = 511;
