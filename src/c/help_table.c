...
const HelpEntry help_entries[] = {
	...
	{ "bootstrap", "( data fit-xt B -- arr )", "statistics.h2o: B refits of fit-xt over row-resamples of data; deterministic under a fixed seed", "B(n + fit)", "B resamples + 1a(B)", "O(B·(n + fit))", 18 },
	...
	{ "pbootstrap", "( data fit-xt B -- arr )", "statistics.h2o: bootstrap with the refits run under pmap — same distribution (resampling stays serial), parallel fit", "as bootstrap", "as bootstrap", "O(B·(n + fit) / cores)", 18 },
	...
	{ "resample-indices", "( n -- arr )", "datasets.h2o: n indices drawn from [0,n) with replacement (bootstrap)", "2n", "2×1a(n)", "O(n)", 22 },
...
const int help_entry_count = 476;
