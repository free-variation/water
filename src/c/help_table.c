...
const HelpEntry help_entries[] = {
	...
	{ "catch", "( xt -- result 0 | exc 1 )", "lib.h2o: reset execute 0", "—", "cont if thrown", "O(xt)" },
	...
	{ "try-catch", "( normal-xt err-xt -- … )", "lib.h2o: run normal-xt; on throw, run err-xt with exc on the stack", "—", "cont if thrown", "O(normal-xt)" },
